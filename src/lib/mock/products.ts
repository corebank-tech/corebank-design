...
export const MOCK_PRODUCT_DETAILS: Record<string, ProductDetailData> = {
  ...
  P002: {
    ...
    guide: [
      ...
      { label: "가입금액", value: "매월 10,000원 이상, 3,000,000원 이하 자유 납입" },
      { label: "이자지급시기", value: "만기일에 원금과 이자를 함께 지급합니다." },
      { label: "중도해지", value: "만기 전 해지 시 중도해지이율이 적용됩니다." },
    ],
    rates: [
      { period: "12개월", baseRate: 3.70, primeRate: 0.40, maxRate: 4.10 },
      { period: "24개월", baseRate: 3.85, primeRate: 0.35, maxRate: 4.20 },
      { period: "36개월", baseRate: 3.90, primeRate: 0.30, maxRate: 4.20 },
    ],
    notices: COMMON_NOTICES,
  },
  P003: {
    ...
    rates: [
      { period: "12개월", baseRate: 3.50, primeRate: 0.30, maxRate: 3.80 },
      { period: "24개월", baseRate: 3.65, primeRate: 0.30, maxRate: 3.95 },
      { period: "36개월", baseRate: 3.70, primeRate: 0.30, maxRate: 4.00 },
      { period: "60개월", baseRate: 3.75, primeRate: 0.30, maxRate: 4.05 },
    ],
    notices: COMMON_NOTICES,
  },
  P004: {
    ...
    guide: [
      ...
      { label: "가입금액", value: "매월 50,000원 이상, 2,000,000원 이하 정액 납입" },
      { label: "이자지급시기", value: "만기일에 원금과 이자를 함께 지급합니다." },
      { label: "중도해지", value: "만기 전 해지 시 중도해지이율이 적용됩니다." },
    ],
    rates: [
      { period: "6개월", baseRate: 3.80, primeRate: 0.40, maxRate: 4.20 },
      { period: "12개월", baseRate: 3.95, primeRate: 0.40, maxRate: 4.35 },
      { period: "24개월", baseRate: 3.90, primeRate: 0.35, maxRate: 4.25 },
    ],
    notices: COMMON_NOTICES,
  },
  P005: {
    ...
    rates: [
      { period: "1개월", baseRate: 2.60, primeRate: 0.10, maxRate: 2.70 },
      { period: "3개월", baseRate: 2.85, primeRate: 0.15, maxRate: 3.00 },
      { period: "6개월", baseRate: 3.05, primeRate: 0.20, maxRate: 3.25 },
      { period: "12개월", baseRate: 3.15, primeRate: 0.25, maxRate: 3.40 },
    ],
    notices: COMMON_NOTICES,
  },
  P006: {
    ...
    guide: [
      { label: "가입대상", value: "실명의 개인 (1인 1계좌)" },
      { label: "가입기간", value: "12개월 이상 36개월 이하 (월 단위 선택)" },
      { label: "가입금액", value: "매월 30,000원 이상, 5,000,000원 이하 정액 납입" },
      { label: "이자지급시기", value: "만기일에 원금과 이자를 함께 지급합니다." },
      { label: "중도해지", value: "만기 전 해지 시 중도해지이율이 적용됩니다." },
    ],
    rates: [
      { period: "12개월", baseRate: 3.95, primeRate: 0.45, maxRate: 4.40 },
      { period: "24개월", baseRate: 4.00, primeRate: 0.45, maxRate: 4.45 },
      { period: "36개월", baseRate: 4.05, primeRate: 0.45, maxRate: 4.50 },
    ],
    notices: COMMON_NOTICES,
  },
}
