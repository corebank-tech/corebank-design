        ...
        {code && (
          <div className="mt-3 w-full">
            <button
              ...
              className="mx-auto flex items-center gap-1 text-xs text-ink-faint hover:text-ink-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              오류코드 보기
              <ChevronDown
            ...
            {codeOpen && (
              <p className="mt-1.5 text-center text-sm tabular-nums text-ink-muted">
                오류코드 : {code}
              </p>
            )}
          </div>
