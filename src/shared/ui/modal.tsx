...
export function Modal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-[var(--z-modal)] flex items-center justify-center bg-[var(--color-overlay)] p-6"
      onMouseDown={(e) => {
        ...
        >
          ...
          {!hideCloseButton && (
            <button
              ...
              onClick={onClose}
              aria-label="닫기"
              className="inline-flex h-7 w-7 items-center justify-center rounded-[var(--radius)] text-current transition-colors hover:bg-[var(--color-white-veil)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-white-ring)]"
            >
